...
func (uu *UserUsecase) RegisterUser(user domain.User) (string, string, domain.Error) {
	...
	return token, refreshToken, domain.Error{}
}

func (uu *UserUsecase) Login(user domain.User) (string, string, domain.Error) {
